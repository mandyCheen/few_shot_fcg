...
for seed in seeds:
    ...
    for model in models:
        ...
        for exp in expList:
            ...
            options = load_config("./config/config_label_prop_d1.json")
            print("exp: ", exp)
            ...
            save_config(options, "./config/config_label_prop_d1.json")
            ...
            try:
                ...
                open("./logs/Error_lp_models_exp_GAT.txt", "a").write(f"{exp} {model} {seed} {e}\n")
